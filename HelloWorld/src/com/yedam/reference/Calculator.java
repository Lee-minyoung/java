...
//		//초기데이터
//		bookRepository[0] = new Book("이것이 자바다.","신용권","한빛미디어",10000);
//		bookRepository[1] = new Book("자바스크립트기초","김자바","자바출판사",15000);
//		bookRepository[2] = new Book("혼자공부하는자바","신용권","한빛미디어",20000);
	}
...
//		};
	...
	// 두 숫자 중에서 큰 값을 반환
	public int getMax(int sum1, int sum2) {
